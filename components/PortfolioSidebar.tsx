...
const socials = [
  {
    label: "GitHub",
    href: "https://github.com/aradhyas8",
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/aradhyas8/",
...
export default function PortfolioSidebar({
  ...
  return (
    <aside className="portfolio-identity" aria-label="About Aradhya Singh">
      {archive ? (
        <a className="identity-name" href="/" aria-label="Aradhya Singh, home">
          <RippleText lines={["Aradhya", "Singh."]} label="Aradhya Singh" rise />
        </a>
      ) : (
      ...
      <p className="identity-intro">
        Software engineer in Toronto. I build mobile products, document tools, and the services behind them.
      </p>

      <a className="text-link identity-resume" href={resume} target="_blank" rel="noopener noreferrer">Résumé ↗</a>

      <SectionNav archive={archive} counts={counts} />
